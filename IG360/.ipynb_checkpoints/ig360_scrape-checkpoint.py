...
class IG360Scrape:
    ...
    def scrape_profile(self, user):
        ...
        # find elements
        txt_user_name = self.driver.find_element_by_xpath('//h1[@class="_7UhW9       fKFbl yUEEX   KV-D4            fDxYl     "]')
    ...
    def scrape_post(self, picture_id):
        ...
        # extract name, location, comments
...
if __name__ == '__main__':
    ...
    # login
    scraper = IG360Scrape('top_repost_architecture','Sharedpass1')
    #scraper.login()

    # scrape a profile
    scraper.scrape_profile("jennyenglishtoronto")
    ...
    #scraper.scrape_post_list("jennyenglishtoronto", 35)
    ...
    #scraper.scrape_followers('jennyenglishtoronto')
    #print("Followers: {}".format(scraper.record_follower_list))

    #capture list of following
    #scraper.scrape_following('jennyenglishtoronto')
